...
object StartScriptBuild extends Build {
    ...
    lazy val rootSettings = Defaults.defaultSettings ++
        Seq(sbtPlugin := true,
            ...
            // to release, bump major/minor/micro as appropriate, drop SNAPSHOT, tag and publish.
            // add snapshot back so git master is a SNAPSHOT.
            // when releasing a SNAPSHOT to the repo, bump the micro version at least.
            // Also, change the version number in the README.md
            // Versions and git tags should follow: http://semver.org/
            // except using -SNAPSHOT instead of without hyphen.

            version := "0.5.2-mslinn",
